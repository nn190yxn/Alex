...
export const firstRoundSteps: FirstRoundStep[] = [
  {
    ...
    actionLabel: '补充品牌资料',
    route: '/brands',
    guide: '先把品牌介绍、课程或产品、目标客户、卖点、FAQ 和竞品资料放进系统，后面的测试问题会更准确。'
  },
  {
    key: 'questions',
    title: '选择测试问题',
    description: '查看系统推荐的高价值测试问法。',
    actionLabel: '去选测试问题',
    route: '/monitoring',
    guide: '测试问题用于模拟用户在 AI 平台里的真实提问，优先选择品牌推荐、地域推荐、年龄段需求和竞品对比问题。'
  },
  {
    key: 'connect',
    title: '连接 AI 平台',
    description: '确认豆包、Kimi、DeepSeek 和通义千问的测试方式。',
    actionLabel: '去连接平台',
    route: '/monitoring',
    guide: '平台密钥已填写的平台会自动测试；暂时没有密钥的平台可以用浏览器或手动粘贴回答完成首轮测试。'
  },
  {
    key: 'test',
    title: '开始测试',
    description: '发起首轮测试并等待回答分析。',
    actionLabel: '开始首轮测试',
    route: '/monitoring',
    guide: '开始测试后，系统会记录每个平台的回答，并自动分析有没有出现品牌、排第几、说得准不准和竞品表现。'
  },
  {
    key: 'review',
    title: '查看建议',
  ...
  },
  {
    ...
    guide: '根据测试结果补齐官网 FAQ、公众号推文、小红书图文、短视频脚本和平台介绍文案，再安排发布和负责人。'
  },
  {
    key: 'retest',
    title: '再次测试',
    description: '再次测试推荐率、排名和表达准确性变化。',
    actionLabel: '安排再次测试',
    route: '/tasks',
    guide: '优化动作完成后，用同一批测试问题再测一次，比较优化前后的推荐率、排名和表达准确性。'
  }
];
