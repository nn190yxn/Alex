...
统一页面骨架位于 `当前工作区/geo-platform/apps/web/src/components/ProductPage.tsx`。
...
统一页面状态组件位于 `当前工作区/geo-platform/apps/web/src/components/PageState.tsx`。
...
统一筛选 query 位于 `当前工作区/geo-platform/apps/web/src/app/filterQuery.ts`，共享组件位于 `当前工作区/geo-platform/apps/web/src/components/`。
...
工作区共享状态和三类页面模板位于 `当前工作区/geo-platform/apps/web/src/components/`。
