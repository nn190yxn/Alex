...
- `当前工作区/geo-platform/apps/web/src/layouts/AppLayout.tsx`
- `当前工作区/geo-platform/apps/web/src/layouts/navigation.ts`
...
- `当前工作区/geo-platform/apps/web/src/layouts/AppLayout.tsx`：当前应用壳
- `当前工作区/geo-platform/apps/web/src/layouts/navigation.ts`：当前导航和工作流
- `当前工作区/geo-platform/apps/web/src/features/brand-workspace/pages/BrandWorkspacePage.tsx`：当前新手首页和品牌工作区
- `当前工作区/geo-platform/apps/web/src/styles/global.css`：当前全局视觉样式
