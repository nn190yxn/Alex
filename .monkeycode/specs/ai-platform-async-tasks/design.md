...
- Builds on `当前工作区/geo-platform/apps/api/src/modules/platforms/adapters/ai-platform.adapter.ts`.
...
- `当前工作区/geo-platform/apps/api/src/modules/platforms/adapters/ai-platform.adapter.ts`
- `当前工作区/geo-platform/apps/api/src/modules/monitoring/monitoring.controller.ts`
- `当前工作区/geo-platform/apps/api/src/modules/content/content.controller.ts`
