...
const pillarTagMap = {
  ...
  'salary-cost-ratio-restaurant': '必备', 'course-structure-education': '核心', 'breakeven-profit-education': '核心',
  'teacher-structure-education': '核心', 'gross-margin-beauty': '必备', 'break-even-beauty': '必备',
...
export const allTools = [
  ...
  createTool({ code: 'food-yield-rate', name: '食材出成率计算器', description: '帮你算食材从毛料到净料的出成比例和真实成本。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['出成率', '净料率', '食材成本'] }),
  ...
  createTool({ code: 'inventory-turnover', name: '库存周转率计算器（餐饮版）', description: '帮你算食材库存周转是否健康，避免积压浪费资金。', tag: '计算', iconColor: 'green', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['库存', '周转率', '资金效率'] }),
  ...
  createTool({ code: 'repurchase-rate', name: '复购率/回头客计算器（餐饮版）', description: '帮你算有多少顾客愿意回头再来，附带 LTV 客户价值估算。', tag: '计算', iconColor: 'blue', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['复购率', '回头客', 'LTV'] }),
  createTool({ code: 'cup-efficiency', name: '出杯效率计算器（奶茶版）', description: '奶茶/小吃店专用，算平均出杯效率、高峰压力、峰谷比，替代翻台率。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['出杯效率', '奶茶', '高峰分析'] }),
  createTool({ code: 'drink-cost', name: '饮品配方成本计算器（奶茶版）', description: '拆解每杯奶茶的原料成本，自动计算毛利率和定价建议。', tag: '计算', iconColor: 'pink', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['配方成本', '奶茶', '定价'] }),
  ...
  createTool({ code: 'course-structure-education', name: '校区品项结构与课程利润计算器', description: '科目×班型×满班率×课酬占比×退费五维分析，自动输出行业基准诊断。', tag: '核心', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['课程利润', '满班率', '课酬占比'] }),
  createTool({ code: 'teacher-structure-education', name: '校区人工成本与师资效能分析器', description: '全职/兼职成本对比+专兼职结构优化+师均产值+流失成本，一表看清师资效率。', tag: '核心', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['师资效能', '专兼职', '人力成本'] }),
  createTool({ code: 'renewal-classrate-education', name: '续费消课与预收健康计算器', description: '续班+消课+预收合规三红线+转介绍+退费预警，一站式校区健康诊断。', tag: '核心', iconColor: 'rose', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['续班率', '消课率', '预收合规'] }),
  createTool({ code: 'funnel-ltv-education', name: '招生转化与LTV计算器', description: '全渠道漏斗+CAC+LTV+LTV/CAC比值，渠道基准对比，找到最优招生策略。', tag: '核心', iconColor: 'indigo', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['招生漏斗', '获客成本', 'LTV'] }),
  createTool({ code: 'breakeven-profit-education', name: '校区盈亏平衡与净利预测器', description: '固定/变动成本拆分+保本业绩+目标利润+租金/营销诊断，校区经营总仪表盘。', tag: '核心', iconColor: 'amber', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['盈亏平衡', '净利预测', '保本营收'] }),
  createTool({ code: 'campus-roi-education', name: '校区投资回报计算器', description: '校区定位+投资明细+回本周期+单学员模型，新项目/新校区投资决策工具。', tag: '专项', iconColor: 'cyan', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['投资回报', '回本周期', 'ROI'] }),
  createTool({ code: 'venue-efficiency-education', name: '教室坪效与排课优化计算器', description: '教室类型适配+时段利用率+坪效分析+增教室vs增时段对比，排课优化决策。', tag: '专项', iconColor: 'violet', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['education'], freePolicy: '5/day', sceneTags: ['坪效', '排课优化', '教室利用'] }),
...
export const industryEntries = [
  ...
  },
  {
    ...
    accent: '#2563eb',
    featuredCodes: ['close-deal', 'friend', 'salary', 'topic', 'business-plan', 'course-structure-education', 'teacher-structure-education', 'renewal-classrate-education', 'funnel-ltv-education', 'breakeven-profit-education', 'campus-roi-education', 'venue-efficiency-education']
  },
  {
    slug: 'beauty',
    name: '美业版',
...
export const industryTemplateEntries = [
  ...
  // 教培行业模板（补充9个）
  {
    ...
    linkedTools: ['course-structure-education', 'breakeven-profit-education'],
    plannedTools: [],
    sceneTags: ['营收', '利润', '经营趋势'],
  ...
  },
  {
    ...
    linkedTools: ['teacher-structure-education', 'schedule'],
    plannedTools: [],
    sceneTags: ['考勤', '排课', '人事'],
  ...
  },
  {
    ...
    linkedTools: ['close-deal', 'funnel-ltv-education', 'renewal-classrate-education'],
    plannedTools: [],
    sceneTags: ['客户管理', '招生'],
  ...
  },
  {
    ...
    linkedTools: ['venue-efficiency-education', 'teacher-structure-education', 'schedule'],
    plannedTools: [],
    sceneTags: ['排课', '教室', '预约'],
  ...
  },
  {
    ...
    linkedTools: ['funnel-ltv-education'],
    plannedTools: [],
    sceneTags: ['供应商', '采购'],
  ...
  },
  {
    ...
    linkedTools: ['course-structure-education'],
    plannedTools: [],
    sceneTags: ['库存', '盘点', '器材'],
  ...
  },
  {
    ...
    linkedTools: ['renewal-classrate-education', 'funnel-ltv-education'],
    plannedTools: [],
  ...
  },
  {
    ...
    linkedTools: ['teacher-structure-education'],
    plannedTools: [],
    sceneTags: ['业绩', '教练', '考核'],
  ...
  },
  {
    ...
    linkedTools: ['funnel-ltv-education', 'breakeven-profit-education', 'close-deal'],
    plannedTools: [],
  ...
  },
  {
    ...
    linkedTools: ['labor-efficiency-beauty', 'venue-efficiency-education', 'schedule'],
    plannedTools: [],
    sceneTags: ['排期', '预约', '房间'],
