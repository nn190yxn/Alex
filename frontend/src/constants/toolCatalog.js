...
export const allTools = [
  ...
  createTool({ code: 'topic', name: '选题生成器', description: '持续补充老板账号、门店账号的内容选题池。', tag: '内容', iconColor: 'purple', requiredLevel: MEMBER_LEVEL_STARTER, category: 'planning', industries: ['education', 'beauty', 'douyin'], capabilityType: 'industry', sceneTags: ['选题', '内容规划'] }),
  ...
  createTool({ code: 'gross-margin-restaurant', name: '毛利率计算器（餐饮版）', description: '输入售价和食材成本，快速判断每道菜的利润空间。', tag: '计算', iconColor: 'orange', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['毛利率', '菜品定价', '利润判断'] }),
  createTool({ code: 'break-even-restaurant', name: '盈亏平衡点计算器（餐饮版）', description: '帮你算出每天至少卖多少才不亏。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['盈亏平衡', '保本营业额'] }),
  ...
  createTool({ code: 'dish-pricing', name: '菜品定价计算器', description: '从成本反推合理售价，定高了没人买、定低了白忙活。', tag: '计算', iconColor: 'teal', requiredLevel: MEMBER_LEVEL_FREE, category: 'finance', industries: ['restaurant'], freePolicy: '5/day', sceneTags: ['定价', '菜品'] }),
