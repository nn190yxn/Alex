    ...
    <div className="app-shell" data-theme={theme} data-mode={mode} data-locale={locale} style={themeStyle(tokens)}>
      ...
      <main className="main-content">
        <header className="page-header">
          <div><span className="eyebrow">{formatDateHeading(selectedDate, i18n)}</span><h1>{i18n.t(currentPage.labelKey)}</h1><p>{pageDescription(page, focusedTask, i18n)}</p></div>
          <div className="header-actions">
            ...
            <Button tone="primary" onClick={() => openNewTask()}><Icon name="plus" />{i18n.t("task.new")}</Button>
          </div>
        </header>

        {page !== "focus" && page !== "calendar" ? (
